"""
Django settings for cloudfund project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-(87kee%8jx*f0*a%j%%^z84*e-2893nk0^r@ec2v^#+a@!o0^n')
...
WSGI_APPLICATION = 'cloudfund.wsgi.application'
